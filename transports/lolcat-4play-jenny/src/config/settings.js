...
export const normaliseSettings = (settings = {}) => ({
  ...
  flaresolverrUrl:
    typeof settings.flaresolverrUrl === "string"
      ? settings.flaresolverrUrl.trim()
      : "",
  flaresolverrTimeoutMs: numberSetting(
    settings.flaresolverrTimeoutMs,
    60000,
    10000,
  ),
...
export const settingsSchemaFor = (name) => [
  ...
  {
    key: "useContainer",
    label: "Use Firefox containers",
    type: "toggle",
    default: "true",
  },
  {
    key: "maxPoolSize",
    label: "Max clean containers",
    type: "number",
    default: "4",
  },
  {
    key: "cleanTtlMs",
    label: "Clean session TTL (ms)",
    type: "number",
    default: "3600000",
  },
  {
    key: "degradedTtlMs",
    label: "CAPTCHA-solved/degraded TTL (ms)",
    type: "number",
    default: "600000",
  },
  {
    key: "warmupQuery",
    label: "Human warmup query",
    type: "text",
    default: "weather",
  },
  {
    key: "humanMinDelayMs",
    label: "Minimum typing delay (ms)",
    type: "number",
    default: "45",
  },
  {
    key: "humanMaxDelayMs",
    label: "Maximum typing delay (ms)",
    type: "number",
    default: "130",
  },
  {
    key: "autoWarmMs",
    label: "Auto warm interval (ms, 0 off)",
    type: "number",
    default: "0",
  },
  {
    ...
    default: "false",
    description:
      "When on, warmup still runs normally but fetches then open a real browser tab and read the site's raw base64 HTML response through 4play instead of replaying the warmed session with curl-impersonate. This is slower, but may have less chance of being detected.",
  },
  {
    key: "flaresolverrUrl",
    ...
    default: "",
    description:
      "Optional fallback challenge solver endpoint, e.g. http://flaresolverr:8191",
  },
  {
    key: "flaresolverrTimeoutMs",
  ...
  },
  {
    ...
    type: "select",
    default: "none",
    options: ["none", "http", "https", "socks5", "socks4"],
  },
