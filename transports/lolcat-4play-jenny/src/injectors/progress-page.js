const PROGRESS_TEXT_RE = /^(?:continue|next|proceed|i agree|agree|accept|accept all|allow all|yes,? continue|not now|skip|here)$/i;
...
export const progressPageJs = () => `(() => {
  ...
  const candidates = [...document.querySelectorAll('a[href], button, input[type="submit"], input[type="button"]')];
